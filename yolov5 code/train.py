...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    is_coco = isinstance(val_path, str) and val_path.endswith('val.txt')  # COCO dataset
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/depth.yaml', help='dataset.yaml path')
...
if __name__ == "__main__":
    ...
    # tensorboard --logdir ~/yolov5-master/runs/train/exp
